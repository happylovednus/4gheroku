# Giới thiệu:
Đây là một repository được fork lại từ [https://github.com/happylovednus/4gheroku] với chức năng là tạo ra một server V2Ray trên heroku một cách đơn giản nhất.
